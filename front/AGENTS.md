...
- **Делает:** вкладки Проекты / Воркстейшны / Сессии / Файлы / Чат / Config
  ...
  список (название, url API, ключ доступа виден как есть), создание, правка и
  удаление); страница истории на
...
- Unit (vitest): модели/фильтры (`workstation.test.ts`), утилиты
  ...
  (`project/llm-list.test.tsx` — название, url и ключ видны), редактор каталога
