...
- **Делает:** вкладки Проекты / Воркстейшны / Сессии / Файлы / Чат / Config
  (второе топ-меню: Env / Users / Skills / Commands / Agent Set / LLM / Help); создание
...
- Unit (vitest): модели/фильтры (`workstation.test.ts`), утилиты
  ...
  воркстейшна её нет), страница изменений
  ...
  (`pages/app/config-help.test.tsx` — пункт Help в меню Config, диаграмма состава
